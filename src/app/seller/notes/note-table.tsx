...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
          ...
          <Input className="max-w-xs" placeholder="private filter..."
              value={(table.getColumn("private")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("private")?.setFilterValue(event.target.value)}                
          />
