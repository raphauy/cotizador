...
import { createVersionAction, getCotizationDAOAction, getNextLabelAction, getVersionsCountAction } from "../cotization-actions";
...
export default function NewCotizationPage({ searchParams }: Props) {
